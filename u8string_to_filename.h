...
// include a '/'.
//
std::filesystem::path u8string_to_filename(
...
std::u8string filename_to_u8string(std::filesystem::path const& filename, std::u8string const& from = u8"_\u2017\u2215", std::u8string const& to = u8" _/");
