...
#error "Including utils/FunctionView.h -- which isn't MIT licensed."
#endif
 ...
 * be found in the LICENSE.FunctionView file in the source tree.
 *
...
// Example use:
//
//   void SomeFunction(utils::FunctionView<int(int)> index_transform);
//   ...
